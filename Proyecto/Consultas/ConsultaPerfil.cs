...
namespace Proyecto.Consultas {
    class ConsultaPerfil {
        ...
        //.....
        public async static Task<List<ObjetoPerfil>> getJsonPerfil(String url) {
            using (HttpClient client = new HttpClient()){
                ...
                if (response.IsSuccessStatusCode) {
                    ...
                    List<ObjetoPerfil> msg = JsonConvert.DeserializeObject<List<ObjetoPerfil>>(content);

                    System.Diagnostics.Debug.WriteLine("Contenido del json: " + content);

                    return msg;
                } else {
                    System.Diagnostics.Debug.WriteLine("Error consulta perfil");
                    return null;
                }
            }

        }
        public async static Task<List<ObjetoError>> getJsonPerfilErrors(String url)
        {
            using (HttpClient client = new HttpClient())
            {

...
namespace Proyecto.Consultas
{
    class ConsultaRedes
    {
        ...
        public async static Task<List<RedesSociales>> getJsonRedes(String url)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    List<RedesSociales> msg = JsonConvert.DeserializeObject<List<RedesSociales>>(content);
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Error consulta redes");
                    return null;
                }
            }

        }
        public async static Task<List<ObjetoError>> getJsonRedesErrors(String url)
        {
            using (HttpClient client = new HttpClient())
            {
                ...
                {
                    System.Diagnostics.Debug.WriteLine("Error consulta error redes");
                    return null;
                }
            }
